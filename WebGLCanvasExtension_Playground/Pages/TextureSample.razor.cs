...
{
    public partial class TextureSample : ComponentBase
    {
        ...
        async Task SetupContext()
        {
            ...
            _program = await ShaderProgram.InitShaderProgram(_context,
                await Http.GetStringAsync("shaders/tex.vert"),
                await Http.GetStringAsync("shaders/tex.frag"));
